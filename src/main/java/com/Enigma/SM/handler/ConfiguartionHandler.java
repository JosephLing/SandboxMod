...
public class ConfiguartionHandler
{
    ...
    private static void loadConfiguation()
    {
        ...
        DG_nTRIES = configuration.getInt("nDungeonRoomTries", Configuration.CATEGORY_GENERAL,250, 1 ,2500, "the number of attempts to create a room");
        DG_XSIZE = configuration.getInt("DungeonXsize", Configuration.CATEGORY_GENERAL,40, 40, 500, "how large the dungeon will be in the X direction");
        DG_ZSIZE = configuration.getInt("DungeonZsize", Configuration.CATEGORY_GENERAL,40, 40, 500, "how large the dungeon will be in the Z direction");
