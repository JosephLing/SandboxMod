...
public class Dungeon implements IWorldGenerator
{
    ...
    public void generate(Random random, int chunkX, int chunkZ, World world, IChunkProvider chunkGenerator, IChunkProvider chunkProvider)
    {
        ...
        int yHeight = 6;
        if (Xchunk % 100 == 0 && Zchunk % 100 == 0 && random.nextInt(2) == 0 && world.provider.dimensionId == 0 && world.getBiomeGenForCoords(Xchunk, Zchunk) != BiomeGenBase.ocean && world.getBiomeGenForCoords(Xchunk, Zchunk) != BiomeGenBase.deepOcean && world.getBiomeGenForCoords(Xchunk, Zchunk) != BiomeGenBase.extremeHills && world.getBiomeGenForCoords(Xchunk, Zchunk) != BiomeGenBase.extremeHillsPlus && world.getBiomeGenForCoords(Xchunk, Zchunk) != BiomeGenBase.extremeHillsEdge)
        {
            ...
            LogHelper.info("took: " + (StartTime - System.nanoTime()) + " seconds");
        }
    }
